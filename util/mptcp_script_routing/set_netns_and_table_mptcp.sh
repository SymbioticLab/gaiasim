...
sudo ip route add 10.0.0.0/16 dev $host-eth0 table 1
...
sudo ip route add 10.1.0.0/16 dev $host-eth1 table 2
...
sudo ip route add 10.2.0.0/16 dev $host-eth2 table 3
