...
sudo ifconfig macv1 10.0.3.3/24
...
sudo ip route add 10.0.1.1 via 10.10.13.1
sudo ip route add 10.0.2.2 via 10.10.23.2
sudo ip route add 10.0.4.4 via 10.10.34.4
sudo ip route add 10.0.5.5 via 10.10.35.5
