...
sudo ifconfig macv1 10.0.5.5/24
...
sudo ip route add 10.0.1.1 via 10.10.35.3
sudo ip route add 10.0.2.2 via 10.10.45.4
sudo ip route add 10.0.3.3 via 10.10.35.3
sudo ip route add 10.0.4.4 via 10.10.45.4
