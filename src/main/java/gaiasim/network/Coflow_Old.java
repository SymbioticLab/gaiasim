...
public class Coflow_Old {
    ...
    public String id;
    public HashMap<String, FlowGroup_Old> flows_ = new HashMap<String, FlowGroup_Old>();
            ...
            for (String src_loc : child.task_locs_) {
                ...
                for (String dst_loc : task_locs_) {
                    ...
                    if (src_loc != dst_loc) {
                        ...
                        flows_.put(flow_id, new FlowGroup_Old(flow_id, flow_id_suffix, id, src_loc, dst_loc, volume_per_flow));
//                        System.out.println("CoFlow: created flow id: " + flow_id + " owned by coflow id: " + id + " with volume " + volume_per_flow);
    ...
    public void determine_start_time() {
        ...
        for (String k : flows_.keySet()) {
            ...
            if (f.getStart_timestamp() < start_timestamp_) {
                start_timestamp_ = f.getStart_timestamp();
            }
        }
    }
