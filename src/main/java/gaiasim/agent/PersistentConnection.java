            ...
            while (true) {
                ...
                if (data_.total_rate > 0.0) {
                    try {
                        ...
                        double cur_rate = data_.total_rate * Constants.CHEAT_FACTOR_A; // FIXME: also cheat here.
...
//                        System.out.println("PersistentConn: Flushed Writing " + data_length + " w/ rate: " + data_.total_rate + " Mbit/s  @ " + System.currentTimeMillis());
                        ...
                        data_.distribute_transmitted( Constants.CHEAT_FACTOR_B * tx_ed); // FIXME: cheat here!
